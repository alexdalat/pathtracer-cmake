    ...
    while (getline(f, line)) {
        ...
        if (line.rfind("f ", 0) == 0) {
            if (std::regex_match(line, std::regex(R"(f( [0-9]+){3})", std::regex_constants::extended))) {
                int i0, i1, i2;
                sscanf_s(line.c_str(), "f %d %d %d", &i0, &i1, &i2);
                ...
                sscanf_s(line.c_str(), "f %d/%d/%d %d/%d/%d %d/%d/%d", &v0, &vn0, &vt0, &v1, &vn1, &vt1, &v2, &vn2, &vt2);
                ...
                sscanf_s(line.c_str(), "f %d//%d %d//%d %d//%d", &v0, &vt0, &v1, &vt1, &v2, &vt2);
